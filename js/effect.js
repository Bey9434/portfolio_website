...
function drop(e) {
    ...
    // 4つの弾痕画像のURLリスト
    const bulletImages = [
        'portfolio_website/img/effects/k0100_0.png',
        'portfolio_website/img/effects/k0100_1.png',
        'portfolio_website/img/effects/k0100_2.png',
        'portfolio_website/img/effects/k0100_3.png'
    ];
     // ランダムに1つの画像URLを選択
